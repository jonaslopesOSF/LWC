(function (global, factory) {
    ...
    ***************************************************************************** */
    ...
    var _e = Array.prototype, ArrayJoin$1 = _e.join, ArrayMap$1 = _e.map, ArrayPush$1 = _e.push, ArraySlice$2 = _e.slice, ArrayUnshift$2 = _e.unshift, forEach$1 = _e.forEach;
    ...
    */
    ...
    function notifyProfilerStateChange() {
        for (var i_11 = 0; i_11 < profilerStateCallbacks.length; i_11++) {
            profilerStateCallbacks[i_11](profilerEnabled);
        }
    }
    ...
    function register(service) {
        for (var i_12 = 0; i_12 < hooks.length; ++i_12) {
            var hookName = hooks[i_12];
    ...
    function invokeServiceHook(vm, cbs) {
        ...
        for (var i_13 = 0, len = cbs.length; i_13 < len; ++i_13) {
            cbs[i_13].call(undefined, component, {}, def, context);
        }
    }
    /*
     * Copyright (c) 2018, salesforce.com, inc.
    ...
    function flushRehydrationQueue() {
        ...
        for (var i_14 = 0, len = vms.length; i_14 < len; i_14 += 1) {
            var vm = vms[i_14];
            try {
                rehydrate(vm);
            }
                ...
                if (i_14 + 1 < len) {
                    ...
                    ArrayUnshift$2.apply(rehydrateQueue, ArraySlice$2.call(vms, i_14 + 1));
    ...
    function runShadowChildNodesDisconnectedCallback(vm) {
        ...
        for (var i_15 = vCustomElementCollection.length - 1; i_15 >= 0; i_15 -= 1) {
            var elm = vCustomElementCollection[i_15].elm; // There are two cases where the element could be undefined:
    ...
    function recursivelyDisconnectChildren(vnodes) {
        for (var i_16 = 0, len = vnodes.length; i_16 < len; i_16 += 1) {
            var vnode = vnodes[i_16];
    ...
    function resetShadowRoot(vm) {
        ...
        for (var i_17 = 0, len = children.length; i_17 < len; i_17++) {
            var child = children[i_17];
    ...
    function allocateInSlot(vm, children) {
        ...
        for (var i_18 = 0, len = children.length; i_18 < len; i_18 += 1) {
            var vnode = children[i_18];
            if (isNull$1(vnode)) {
                continue;
            }
            var data = vnode.data;
        ...
        if (isFalse$1$1(vm.isDirty)) {
            ...
            for (var i_19 = 0, len = oldKeys.length; i_19 < len; i_19 += 1) {
                var key = oldKeys[i_19];
    ...
    function connectWireAdapters(vm) {
        ...
        for (var i_20 = 0, len = wiredConnecting.length; i_20 < len; i_20 += 1) {
            wiredConnecting[i_20]();
        }
    }
    function disconnectWireAdapters(vm) {
        ...
        runWithBoundaryProtection(vm, vm, noop$4, function () {
            // job
            for (var i_21 = 0, len = wiredDisconnecting.length; i_21 < len; i_21 += 1) {
                wiredDisconnecting[i_21]();
            }
        }, noop$4);
    }
    /*
